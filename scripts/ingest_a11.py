...
SOURCE_FILE = "rag_sources/A11_uts_indoor_hydroponic_basil_experiment.md"
SOURCE_ID = "A11"
CHUNK_WORDS = 500
OVERLAP_WORDS = 75
...
source = source_match.group(1).strip() if source_match else "University of Technology Sydney research repository"
    ...
    with conn.cursor() as cur:
        ...
        if existing:
            ...
            for idx, chunk_text in chunks:
                ...
                chunk_metadata = {
                    **document_metadata,
                    "section": "Indoor Hydroponic Basil Experiment - UTS",
                    "chunk_index": idx
                }
