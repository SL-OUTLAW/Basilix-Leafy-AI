...
SOURCE_FILE = "rag_sources/A8_ausveg_protected_cropping_in_action.md"
SOURCE_ID = "A8"
CHUNK_WORDS = 500
OVERLAP_WORDS = 75
...
source = source_match.group(1).strip() if source_match else "AUSVEG"
    ...
    with conn.cursor() as cur:
        ...
        if existing:
            ...
            for idx, chunk_text in chunks:
                ...
                chunk_metadata = {
                    **document_metadata,
                    "section": "Protected Cropping in Action - Australian Basil and Soft Herbs",
                    "chunk_index": idx
                }
